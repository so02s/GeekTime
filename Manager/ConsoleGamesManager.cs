...
namespace GeekTime.Manager
{
    ...
    public class ConsoleGamesManager : IConsoleGameManager
    {
        ...
        public static class ConsoleGameList
        {
            ...
            {
                 new ConsoleGames("Overcooked!", 6, "Xbox One", "адрес фотки", "Шелдон"),
                 new ConsoleGames("Mortal Combat 11", 2, "PS4 PRO", "адрес фотки", "Время приключений"),
                 new ConsoleGames("Moving Out", 6, "Xbox One", "адрес фотки", "Татуин"),
                 new ConsoleGames("It takes two", 2, "Xbox SeriaS", "адрес фотки", "Тардис"),
            };
        }
    }
}
